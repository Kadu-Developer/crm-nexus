# /speckit.implement — Credits & Usage
...
- Critical adversarial focus: **double spend, negative balance, duplicate debit, mutable ledger**.
...
## Instrução
Implemente **somente** a feature **013 — Credits & Usage** seguindo:
...
A feature **Credits & Usage** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
