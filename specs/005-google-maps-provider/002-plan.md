# /speckit.plan — Google Maps Prospecting
...
- explicitly address: **API key exposure, quota runaway, stale pagination, ToS/provider contract assumptions**;
...
## Direção técnica
- API/provider permitido para Google Maps/Places
- Retry no worker, não no request
- Normalização de telefone/URL
