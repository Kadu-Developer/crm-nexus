# /speckit.implement — Google Maps Prospecting
...
- Critical adversarial focus: **API key exposure, quota runaway, stale pagination, ToS/provider contract assumptions**.
...
## Instrução
Implemente **somente** a feature **005 — Google Maps Prospecting** seguindo:
...
A feature **Google Maps Prospecting** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
