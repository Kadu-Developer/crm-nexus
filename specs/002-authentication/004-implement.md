...
- Critical adversarial focus: **session security, account enumeration, cookie settings, auth bypass**.
...
## Instrução
Implemente **somente** a feature **002 — Authentication** seguindo:
...
A feature **Authentication** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
