# /speckit.implement — Provider Core
...
- Critical adversarial focus: **provider coupling, secret leakage, error normalization, unbounded external calls**.
...
## Instrução
Implemente **somente** a feature **004 — Provider Core** seguindo:
...
A feature **Provider Core** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
