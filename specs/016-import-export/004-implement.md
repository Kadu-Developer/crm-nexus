# /speckit.implement — Import & Export
...
- Critical adversarial focus: **CSV injection, formula injection, oversized files, cross-tenant export**.
...
## Instrução
Implemente **somente** a feature **016 — Import & Export** seguindo:
...
A feature **Import & Export** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
