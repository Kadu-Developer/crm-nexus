# /speckit.implement — Audit & Observability
...
- Critical adversarial focus: **PII/secrets in logs, missing correlation, false health, noisy alerts**.
...
## Instrução
Implemente **somente** a feature **018 — Audit & Observability** seguindo:
...
A feature **Audit & Observability** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
