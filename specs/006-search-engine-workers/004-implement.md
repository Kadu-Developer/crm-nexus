# /speckit.implement — Search Engine & Workers
...
- Critical adversarial focus: **duplicate jobs, retry storms, race conditions, stuck jobs, poison payloads**.
...
## Instrução
Implemente **somente** a feature **006 — Search Engine & Workers** seguindo:
...
A feature **Search Engine & Workers** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
