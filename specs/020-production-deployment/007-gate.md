# /speckit.gate — Production Deployment
...
- set `current_stage = "FINAL-RELEASE-GATE.md"`;
- keep `final_release = "PENDING"` until final gate passes.
