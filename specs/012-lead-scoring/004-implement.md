# /speckit.implement — Lead Scoring
...
- Critical adversarial focus: **client-forged score, drift, unexplained score changes, hidden bias**.
...
## Instrução
Implemente **somente** a feature **012 — Lead Scoring** seguindo:
...
A feature **Lead Scoring** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
