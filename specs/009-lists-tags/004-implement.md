...
- Critical adversarial focus: **orphan relations, duplicate associations, cross-tenant tagging**.
...
## Instrução
Implemente **somente** a feature **009 — Lists & Tags** seguindo:
...
A feature **Lists & Tags** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
