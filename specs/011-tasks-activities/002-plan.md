...
- explicitly address: **timezone bugs, hidden activities, unauthorized reassignment, history mutation**;
...
## Direção técnica
- Event-driven activity creation
- Due-date queries
