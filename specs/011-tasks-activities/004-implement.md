# /speckit.implement — Tasks & Activities
...
- Critical adversarial focus: **timezone bugs, hidden activities, unauthorized reassignment, history mutation**.
...
## Instrução
Implemente **somente** a feature **011 — Tasks & Activities** seguindo:
...
A feature **Tasks & Activities** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
