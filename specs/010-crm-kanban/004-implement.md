...
- Critical adversarial focus: **lost updates, invalid transitions, ordering races, unauthorized moves**.
...
## Instrução
Implemente **somente** a feature **010 — CRM & Kanban** seguindo:
...
A feature **CRM & Kanban** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
