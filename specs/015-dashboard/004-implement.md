# /speckit.implement — Dashboard & Metrics
...
- Critical adversarial focus: **incorrect metrics, cross-tenant aggregation, expensive queries, timezone errors**.
...
## Instrução
Implemente **somente** a feature **015 — Dashboard & Metrics** seguindo:
...
A feature **Dashboard & Metrics** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
