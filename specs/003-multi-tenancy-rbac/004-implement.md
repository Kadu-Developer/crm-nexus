# /speckit.implement — Multi-Tenancy & RBAC
...
- Critical adversarial focus: **IDOR, cross-tenant leakage, privilege escalation, client-only authorization**.
...
## Instrução
Implemente **somente** a feature **003 — Multi-Tenancy & RBAC** seguindo:
...
A feature **Multi-Tenancy & RBAC** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
