# /speckit.implement — Plans & Billing
...
- Critical adversarial focus: **webhook replay, client-trusted payment state, entitlement bypass, proration edge cases**.
...
## Instrução
Implemente **somente** a feature **014 — Plans & Billing** seguindo:
...
A feature **Plans & Billing** deve estar funcional, testada e integrada ao estado atual do ProspectFlow.
